...
[![告警开关](https://file.kacper.fun/mblog/2024/12/30/b6c355319daf8c4112d0253dbbe39aba.webp "告警开关")](https://file.kacper.fun/mblog/2024/12/30/b6c355319daf8c4112d0253dbbe39aba.webp "告警开关")

##### 7.1.3.2.2 告警静默
“告警静默”配置项若打开，则在静默时间段产生的告警，只会产生告警记录，而不会通过配置的告警方式进行通知。

[![告警静默](https://file.kacper.fun/mblog/2024/12/30/d0db56b1ec2ec59bba09ed4c7c9ea7bc.webp "告警静默")](https://file.kacper.fun/mblog/2024/12/30/d0db56b1ec2ec59bba09ed4c7c9ea7bc.webp "告警静默")
...
[![告警级别](https://file.kacper.fun/mblog/2024/12/30/26e772a0a9a73017eb322694518668f0.webp "告警级别")](https://file.kacper.fun/mblog/2024/12/30/26e772a0a9a73017eb322694518668f0.webp "告警级别")

##### 7.1.3.2.4 方式
告警方式有邮箱、短信、钉钉、企业微信。是一个多选开关，可以同时配置多种告警方式发送告警。其中短信告警需要自己二次开发去对接自己公司的短信服务接口。

[![告警方式](https://file.kacper.fun/mblog/2024/12/30/9c7bc1e6b17efa56a3ad6830463e6e96.webp "告警方式")](https://file.kacper.fun/mblog/2024/12/30/9c7bc1e6b17efa56a3ad6830463e6e96.webp "告警方式")
...
[![网络监控配置](https://file.kacper.fun/mblog/2024/12/30/a07d8c32180c9e98700b3926354b8576.webp "网络监控配置")](https://file.kacper.fun/mblog/2024/12/30/a07d8c32180c9e98700b3926354b8576.webp "网络监控配置")

#### 7.1.3.4 TCP服务
TCP 服务有一个是否监控的开关，打开则监控 TCP 服务，关闭则不监控 TCP 服务。TCP 服务状态是否监控、是否告警也可以单独设置。

[![TCP服务监控配置](https://file.kacper.fun/mblog/2024/12/30/70d5db79caa4c84b434a9f00b0368bb9.webp "TCP服务监控配置")](https://file.kacper.fun/mblog/2024/12/30/70d5db79caa4c84b434a9f00b0368bb9.webp "TCP服务监控配置")

#### 7.1.3.5 HTTP服务
HTTP 服务有一个是否监控的开关，打开则监控 HTTP 服务，关闭则不监控 HTTP 服务。HTTP 服务状态是否监控、是否告警也可以单独设置。

[![HTTP服务监控配置](https://file.kacper.fun/mblog/2024/12/30/9de9f236d48f13b718a700d0564a3d93.webp "HTTP服务监控配置")](https://file.kacper.fun/mblog/2024/12/30/9de9f236d48f13b718a700d0564a3d93.webp "HTTP服务监控配置")

#### 7.1.3.6 数据库
数据库有一个是否监控的开关，打开则监控数据库，关闭则不监控数据库。数据库状态是否监控、是否告警也可以单独设置。

[![数据库监控配置](https://file.kacper.fun/mblog/2024/12/30/1f36767366eb27635ea46f32474e2ab2.webp "数据库监控配置")](https://file.kacper.fun/mblog/2024/12/30/1f36767366eb27635ea46f32474e2ab2.webp "数据库监控配置")

##### 7.1.3.6.1 表空间(Oracle)
Oracle 数据库支持表空间监控，可以设置表空间是否监控、是否告警，以及告警阈值和告警级别，满足条件则进行告警。

[![Oracle表空间监控配置](https://file.kacper.fun/mblog/2024/12/30/af0dc60f22bd436735f3168fba4457cc.webp "Oracle表空间监控配置")](https://file.kacper.fun/mblog/2024/12/30/af0dc60f22bd436735f3168fba4457cc.webp "Oracle表空间监控配置")

#### 7.1.3.7 应用程序
应用程序有一个是否监控的总开关，打开则监控应用程序，关闭则不监控应用程序。应用程序状态是否监控、是否告警也可以单独设置。

[![应用程序监控配置](https://file.kacper.fun/mblog/2024/12/30/410b6e45eb3d11be69b9445e16dfdc25.webp "应用程序监控配置")](https://file.kacper.fun/mblog/2024/12/30/410b6e45eb3d11be69b9445e16dfdc25.webp "应用程序监控配置")

#### 7.1.3.8 服务器
服务器有一个是否监控的开关，打开则监控服务器，关闭则不监控服务器。服务器状态是否监控、是否告警也可以单独设置。

[![服务器监控配置](https://file.kacper.fun/mblog/2024/12/30/1b27b38be80456522a337667236f53b9.webp "服务器监控配置")](https://file.kacper.fun/mblog/2024/12/30/1b27b38be80456522a337667236f53b9.webp "服务器监控配置")
...
[![docker监控监控](https://file.kacper.fun/mblog/2024/12/30/5aa576c0d11b64141a679b618c220365.webp "docker监控监控")](https://file.kacper.fun/mblog/2024/12/30/5aa576c0d11b64141a679b618c220365.webp "docker监控监控")
