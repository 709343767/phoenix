package com.transfar.business.server.dto;
...
public class ServerResponseHeartbeatPackage extends HeartbeatPackage {
	 ...
	 * @author 皮锋
	 */
	public ServerResponseHeartbeatPackage() {
		this.setInstanceId();
	...
	private void setInstanceName() {
		super.setInstanceName("monitoring-server-web");
	}
	...
	private void setEndpoint() {
		super.setEndpoint(EndpointTypeConstant.SERVER);
	}
