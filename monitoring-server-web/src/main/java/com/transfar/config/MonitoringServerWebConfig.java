...
public class MonitoringServerWebConfig {
	...
	public MonitoringServerWebProperties loadConfig() throws IOException {
		...
		return wrap(alarmType, alarmSmsPhoneNumbers, alarmSmsAddress, alarmSmsProtocol, alarmSmsEnterprise);
	}
	 ...
	 * @return MonitoringServerWebProperties
	 */
	private MonitoringServerWebProperties wrap(String alarmType, String alarmSmsPhoneNumbers, String alarmSmsAddress,
