...
import com.gitee.pifeng.server.business.web.service.IMonitorConfigService;
import com.gitee.pifeng.server.business.web.vo.MonitorConfigPageFormVo;
import com.gitee.pifeng.server.inf.IMonitorConfigListener;
...
public class MonitorConfigServiceImpl extends ServiceImpl<IMonitorConfigDao, MonitorConfig> implements IMonitorConfigService {
    ...
    public boolean update(MonitorConfigPageFormVo monitorConfigPageFormVo) {
        ...
        this.monitorConfigListeners.forEach(e ->
                ThreadPool.COMMON_IO_INTENSIVE_THREAD_POOL.execute(e::wakeUpMonitoringConfigPropertiesLoader));
        return true;
    }
