package com.gitee.pifeng.server.business.web;
...
public class MybaisPlusAutoGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + File.separator + "monitoring-server";
        ...
        pc.setParent("com.gitee.pifeng.server.business.web");
        pc.setEntity("entity");
