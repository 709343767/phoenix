...
import com.gitee.pifeng.server.business.web.dao.IMonitorServerDiskDao;
import com.gitee.pifeng.server.business.web.entity.MonitorServerDisk;
import com.gitee.pifeng.server.business.web.service.IMonitorServerDiskService;
import com.gitee.pifeng.server.business.web.vo.ServerDetailPageServerDiskChartVo;
...
public class MonitorServerDiskServiceImpl extends ServiceImpl<IMonitorServerDiskDao, MonitorServerDisk> implements IMonitorServerDiskService {
    ...
    public List<ServerDetailPageServerDiskChartVo> getServerDetailPageServerDiskChartInfo(String ip) {
        List<MonitorServerDisk> monitorServerDisks = this.monitorServerDiskDao.getServerDetailPageServerDiskChartInfo(ip);
