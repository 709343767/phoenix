...
(
    ...
    `LEVEL`           varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '告警级别（IGNORE、INFO、WARN、ERROR、FATAL）',
...
(
    ...
    `IS_ENABLE_ALARM`   varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否开启告警（0：不开启告警；1：开启告警）',
    `EXC_MESSAGE`       longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT '异常信息',
    `RESULT_BODY`       longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT '结果内容',
    `RESULT_BODY_SIZE`  int(8)                                                        NULL DEFAULT NULL COMMENT '结果内容大小（byte）',
    `OFFLINE_COUNT`     int(8)                                                        NULL DEFAULT NULL COMMENT '离线次数',
    `MONITOR_ENV`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控环境',
    `MONITOR_GROUP`     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控分组',
...
(
    ...
    `DEV_NAME`      varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分区的盘符名称',
    `DIR_NAME`      varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分区的盘符路径',
...
(
    ...
    `DOWNLOAD_BPS` double(22, 4)                                                 NULL DEFAULT NULL COMMENT '下载速率',
    `UPLOAD_BPS`   double(22, 4)                                                 NULL DEFAULT NULL COMMENT '上传速率',
    `INSERT_TIME`  datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`  datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
...
(
    ...
    `PORTS`                     varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '端口号列表（逗号分隔）',
    `INSERT_TIME`               datetime                                                       NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`               datetime                                                       NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP'
