...
CREATE TABLE `MONITOR_ALARM_DEFINITION` (
  ...
  `TYPE` varchar(8) NOT NULL COMMENT '告警类型（SERVER、NET、INSTANCE、CUSTOM）',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='告警定义表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1279 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='告警记录表';
...
CREATE TABLE `MONITOR_CONFIG` (
  ...
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='监控配置表';
...
CREATE TABLE `MONITOR_DB` (
  ...
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='数据库表';
...
) ENGINE=InnoDB AUTO_INCREMENT=171 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='应用实例表';
...
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='java虚拟机类加载信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=311 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='java虚拟机GC信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=167601 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='java虚拟机内存信息表';
...
CREATE TABLE `MONITOR_JVM_MEMORY_HISTORY` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `NX_INSTANCE_ID` (`INSTANCE_ID`) USING BTREE COMMENT '索引_应用实例ID',
  CONSTRAINT `MONITOR_JVM_MEMORY_HISTORY_JVM_MEMORY_FK` FOREIGN KEY (`INSTANCE_ID`) REFERENCES `MONITOR_JVM_MEMORY` (`INSTANCE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=232233 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='java虚拟机内存历史记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='java虚拟机运行时信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='java虚拟机线程信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='网络信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='实时监控表';
...
CREATE TABLE `MONITOR_ROLE` (
  ...
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='监控用户角色表';
...
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器表';
...
) ENGINE=InnoDB AUTO_INCREMENT=146817 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器CPU表';
...
CREATE TABLE `MONITOR_SERVER_CPU_HISTORY` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP地址',
  CONSTRAINT `MONITOR_SERVER_CPU_HISTORY_SERVER_CPU_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_CPU` (`IP`)
) ENGINE=InnoDB AUTO_INCREMENT=205209 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器CPU历史记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=73522 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器磁盘表';
...
CREATE TABLE `MONITOR_SERVER_DISK_HISTORY` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
  CONSTRAINT `MONITOR_SERVER_DISK_HISTORY_SERVER_DISK_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_DISK` (`IP`)
) ENGINE=InnoDB AUTO_INCREMENT=103358 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器磁盘历史记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=18356 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器内存表';
...
CREATE TABLE `MONITOR_SERVER_MEMORY_HISTORY` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
  CONSTRAINT `MONITOR_SERVER_MEMORY_HISTORY_SERVER_MEMORY_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_MEMORY` (`IP`)
) ENGINE=InnoDB AUTO_INCREMENT=25928 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器内存历史记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=12438 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器网卡表';
...
CREATE TABLE `MONITOR_SERVER_NETCARD_HISTORY` (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
  CONSTRAINT `MONITOR_SERVER_NETCARD_HISTORY_SERVER_NETCARD_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_NETCARD` (`IP`)
) ENGINE=InnoDB AUTO_INCREMENT=27250 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器网卡历史记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器操作系统表';
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器电池表';
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='服务器传感器表';
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='监控用户表';
