...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '告警定义表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1279 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '告警记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_CONFIG`  (
  ...
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '监控配置表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_DB`  (
  ...
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据库表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 171 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '应用实例表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 156 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机类加载信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 311 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机GC信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 167601 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机内存信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 232233 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机内存历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 187 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机运行时信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 156 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机线程信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网络信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '实时监控表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 150 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 146817 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器CPU表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 205209 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器CPU历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 73522 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器磁盘表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 103358 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器磁盘历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 18356 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器内存表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 25928 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器内存历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12438 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器网卡表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 27250 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器网卡历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器操作系统表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器电池表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器传感器表' ROW_FORMAT = Compact;
