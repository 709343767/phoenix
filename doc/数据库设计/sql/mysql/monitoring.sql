...
CREATE TABLE `MONITOR_ALARM_RECORD`  (
  ...
  `TITLE` varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '告警标题',
  `CONTENT` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '告警内容',
...
CREATE TABLE `MONITOR_LOG_EXCEPTION`  (
  ...
  `EXC_MESSAGE` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '异常信息',
...
CREATE TABLE `MONITOR_LOG_OPERATION`  (
  ...
  `REQ_PARAM` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '请求参数',
  `RESP_PARAM` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '返回参数',
  `USER_ID` bigint(20) NOT NULL COMMENT '操作用户ID',
