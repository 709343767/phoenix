...
(
    ...
    `TYPE`         varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NOT NULL COMMENT '告警类型（SERVER、NET、DATABASE、INSTANCE、CUSTOM）',
    ...
    `TITLE`        varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '告警标题',
...
(
    ...
    `TYPE`           varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NOT NULL COMMENT '告警类型（SERVER、NET、INSTANCE、DATABASE、CUSTOM）',
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_INSTANCE_ID` (`INSTANCE_ID`) USING BTREE COMMENT '索引_应用实例ID',
    CONSTRAINT `MONITOR_JVM_MEMORY_HISTORY_INSTANCE_FK` FOREIGN KEY (`INSTANCE_ID`) REFERENCES `MONITOR_INSTANCE` (`INSTANCE_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    `OPER_METHOD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '操作方法',
...
(
    `ID`            bigint(20)                                                   NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `TYPE`          varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '监控类型（SERVER、NET、INSTANCE、CUSTOM）',
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP地址',
    CONSTRAINT `MONITOR_SERVER_CPU_HISTORY_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
    CONSTRAINT `MONITOR_SERVER_DISK_HISTORY_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
    CONSTRAINT `MONITOR_SERVER_MEMORY_HISTORY_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
    CONSTRAINT `MONITOR_SERVER_NETCARD_HISTORY_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    CONSTRAINT `MONITOR_SERVER_OS_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
    CONSTRAINT `MONITOR_SERVER_POWER_SOURCES_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
    CONSTRAINT `MONITOR_SERVER_PROCESS_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE,
    CONSTRAINT `MONITOR_SERVER_PROCESS_HISTORY_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP',
    CONSTRAINT `MONITOR_SERVER_SENSORS_SERVER_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
