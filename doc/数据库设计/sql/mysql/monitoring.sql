...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '告警定义表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_ALARM_RECORD`  (
  ...
  `ALARM_DEF_CODE` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '告警定义编码',
  ...
  `TITLE` varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '告警标题',
  `CONTENT` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '告警内容',
  ...
  `INSERT_TIME` datetime(0) NOT NULL COMMENT '告警时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '告警记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_CONFIG`  (
  ...
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '监控配置表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_DB`  (
  ...
  `DRIVER_CLASS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '驱动类',
  ...
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据库表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '应用实例表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机类加载信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机GC信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机内存信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_JVM_MEMORY_HISTORY`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `NX_INSTANCE_ID`(`INSTANCE_ID`) USING BTREE COMMENT '索引_应用实例ID',
  CONSTRAINT `MONITOR_JVM_MEMORY_HISTORY_JVM_MEMORY_FK` FOREIGN KEY (`INSTANCE_ID`) REFERENCES `MONITOR_JVM_MEMORY` (`INSTANCE_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机内存历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机运行时信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'java虚拟机线程信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_LOG_EXCEPTION`  (
  ...
  `INSERT_TIME` datetime(0) NOT NULL COMMENT '插入时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '异常日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网络信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '实时监控表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_ROLE`  (
  ...
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '监控用户角色表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器CPU表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_SERVER_CPU_HISTORY`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `NX_IP`(`IP`) USING BTREE COMMENT '索引_IP地址',
  CONSTRAINT `MONITOR_SERVER_CPU_HISTORY_SERVER_CPU_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_CPU` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器CPU历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器磁盘表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_SERVER_DISK_HISTORY`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `NX_IP`(`IP`) USING BTREE COMMENT '索引_IP',
  CONSTRAINT `MONITOR_SERVER_DISK_HISTORY_SERVER_DISK_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_DISK` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器磁盘历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器内存表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_SERVER_MEMORY_HISTORY`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `NX_IP`(`IP`) USING BTREE COMMENT '索引_IP',
  CONSTRAINT `MONITOR_SERVER_MEMORY_HISTORY_SERVER_MEMORY_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_MEMORY` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器内存历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器网卡表' ROW_FORMAT = Compact;
...
CREATE TABLE `MONITOR_SERVER_NETCARD_HISTORY`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  INDEX `NX_IP`(`IP`) USING BTREE COMMENT '索引_IP',
  CONSTRAINT `MONITOR_SERVER_NETCARD_HISTORY_SERVER_NETCARD_FK` FOREIGN KEY (`IP`) REFERENCES `MONITOR_SERVER_NETCARD` (`IP`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器网卡历史记录表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器操作系统表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器电池表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器传感器表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '监控用户表' ROW_FORMAT = Compact;
