...
;layui.define(function (e) {
    layui.use(['admin', 'element', 'form', 'layer', 'laydate', 'util'], function () {
        ...
        function getAvgTimeChartInfo(id, hostnameSource, urlTarget, method, dateValue) {
            admin.req({
                type: 'get',
                url: layui.setter.base + 'monitor-http-history/get-avg-time-chart-info',
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    var option = {
                        title: {
                            ...
                            subtext: '主机名（来源）：' + hostnameSource + '，URL（目的地）：' + urlTarget + '，请求方法：' + method,
                            subtextStyle: {
                                color: '#BEBEBE'
                            }
                        },
