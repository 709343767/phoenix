...
;layui.define(function (e) {
    layui.use(['admin', 'element', 'form', 'layer', 'laydate', 'util'], function () {
        ...
        // 发送ajax请求，获取telnet平均时间
        function getAvgTimeChartInfo(id, hostnameSource, hostnameTarget, portTarget, dateValue) {
            admin.req({
                type: 'get',
                url: layui.setter.base + 'monitor-tcp-history/get-avg-time-chart-info',
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    var option = {
                        title: {
                            ...
                            subtext: '主机名（来源）：' + hostnameSource + '，主机名（目的地）：' + hostnameTarget + '，端口号：' + portTarget,
                            subtextStyle: {
                                color: '#BEBEBE'
                            }
                        },
