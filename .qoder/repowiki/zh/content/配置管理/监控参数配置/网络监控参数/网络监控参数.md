...
## 更新摘要
**变更内容**
- 术语标准化更新：将"下载速度"和"上传速度"统一更新为"下载速率"和"上传速率"
- 数据库表注释标准化：修正MONITOR_SERVER_NETCARD和MONITOR_SERVER_NETCARD_HISTORY表中的字段注释
- Java领域类注释标准化：更新ServerDetailPageServerNetcardVo类中downloadSpeed和uploadSpeed字段的注释
- 前端显示标准化：修正serverDetail.js中HTML标签的显示文本
...
**更新** 术语标准化：系统现已统一使用"下载速率"和"上传速率"替代"下载速度"和"上传速度"，确保技术术语的一致性和准确性。
...
**更新** 术语标准化：网络监控参数中的速率概念现已统一使用"下载速率"和"上传速率"，体现更精确的技术术语表达。
...
**更新** 术语标准化：网卡统计中的"下载速率"和"上传速率"字段现已统一使用标准化术语，确保技术表达的一致性。
...
**更新** 术语标准化：数据库表结构中的DOWNLOAD_BPS和UPLOAD_BPS字段注释已更新为"下载速率"和"上传速率"，确保数据模型与前端显示的一致性。
...
**更新** 术语标准化：性能考量中涉及的"下载速率"和"上传速率"均使用标准化术语，确保技术文档的一致性。
...
**更新** 术语标准化：故障排查指南中的"下载速率"和"上传速率"字段已更新为标准化术语，确保问题诊断的一致性。
...
**更新** 术语标准化：系统现已完成术语标准化更新，统一使用"下载速率"和"上传速率"替代"下载速度"和"上传速度"，确保技术文档、数据库注释、Java领域类注释和前端显示的一致性和准确性。
...
- [application.yml（server）](file://phoenix-server/src/main/resources/application.yml)
- [application.yml（ui）](file://phoenix-ui/src/main/resources/application.yml)
- [phoenix.sql:910-911](file://doc/数据库设计/sql/mysql/phoenix.sql#L910-L911)
- [phoenix.sql:946-947](file://doc/数据库设计/sql/mysql/phoenix.sql#L946-L947)
